...
public class Registros_medicos {
    public static void main(String[] args) {
        ...
        System.out.println("Su frecuencia cardiaca minima esperada es : "+p1.getCalcularFrecuenciaesperadamin());
        System.out.println("Su frecuencia cardiaca maxima esperada es : "+p1.getCalcularFrecuenciaesperadamax());
        System.out.println(" ");

        System.out.printf("*************TABLA BMI***********************");
